...
const Header = ({ onMenuClick, sidebarCollapsed, onToggleCollapse }) => {
  ...
  const [notifications, setNotifications] = useState([
    { Id: 1, title: 'New Project Assigned', message: 'You have been assigned to Project Alpha', time: '5 minutes ago', read: false },
    { Id: 2, title: 'Task Completed', message: 'Task "Update Homepage" has been marked as completed', time: '1 hour ago', read: true },
    { Id: 3, title: 'Meeting Reminder', message: 'Team standup in 15 minutes', time: '2 hours ago', read: false }
  ]);
  ...
  useEffect(() => {
    if (searchQuery.length > 2) {
      const mockResults = [
        { type: 'project', title: 'Project Alpha', subtitle: 'Active project - 5 tasks remaining' },
        { type: 'task', title: 'Update Homepage', subtitle: 'In Progress - Due tomorrow' },
        { type: 'issue', title: 'Login Bug', subtitle: 'Critical - Assigned to you' }
      ].filter(item => 
  ...
  const handleNotificationClick = (notification) => {
    ...
    setShowNotifications(false);
    toast.info(`Opening notification: ${notification.title}`);
  };
